...
// Ambil aktivitas terbaru (jika tabel log_aktivitas ada)
$recent_activities = [];
$log_check = $conn->query("SHOW TABLES LIKE 'log_aktivitas'");
if ($log_check && $log_check->num_rows > 0) {
    $log_query = "SELECT * FROM log_aktivitas ORDER BY tanggal DESC LIMIT 10";
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card text-white bg-primary">
                            <div class="card-body">
                                ...
                                <a href="artikel.php" class="text-white text-decoration-none small">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card text-white bg-success">
                            <div class="card-body">
                                ...
                                <a href="galeri.php" class="text-white text-decoration-none small">
                                    Lihat Detail <i class="bi bi-arrow-right"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card text-white bg-info">
                            <div class="card-body">
                                ...
                                <a href="program-kerja.php" class="text-white text-decoration-none small">
                                    Lihat Detail <i class="bi bi-arrow-right"></i>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 mb-2">
                                        <a href="artikel.php" class="btn btn-outline-primary w-100">
                                            <i class="bi bi-plus-circle me-2"></i>Tambah Artikel
                                        </a>
                                    </div>
                                    <div class="col-md-4 mb-2">
                                        <a href="galeri.php" class="btn btn-outline-success w-100">
                                            <i class="bi bi-plus-circle me-2"></i>Tambah Galeri
                                        </a>
                                    </div>
                                    <div class="col-md-4 mb-2">
                                        <a href="program-kerja.php" class="btn btn-outline-info w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-muted small">
                                                    <?php echo date('d/m/Y H:i', strtotime($activity['tanggal'])); ?>
                                                </td>
